<form class="form-horizontal" method="post"  action="<?php echo site_url('pendidikan/create');?>" enctype="multipart/form-data">
	<div class="form-group row">
	  <label class="col-md-2 col-form-label text-right" for="jenjang">Jenjang</label>
	  <div class="col-md-8">
		<input type="text" id="jenjang" name="jenjang" class="form-control" placeholder="Jenjang" required>
	  </div>
	</div>
	<div class="form-group row">
